...
- Kubeflow Base (`kfbase`) and Kubeflow Pipelines (`kfp`) are deployed. For deployment steps, see [Install Kubeflow Plugins](../../training_pipelines/kubeflow/install.mdx).
- Your namespace is visible in Kubeflow. If the namespace does not appear after you log in to Kubeflow, follow the namespace binding instructions in [Install Kubeflow Plugins](../../training_pipelines/kubeflow/install.mdx).
- KFP object storage is configured. For the namespace-side `kfp-launcher` configuration, see [Use Kubeflow Pipelines](../../training_pipelines/kubeflow/how_to/pipelines.mdx).
...
- The namespace is visible in Kubeflow and is bound to the user. See [Install Kubeflow Plugins](../../training_pipelines/kubeflow/install.mdx).
- KFP is configured to store artifacts in object storage. See [Use Kubeflow Pipelines](../../training_pipelines/kubeflow/how_to/pipelines.mdx).
...
The namespace must be associated with a Kubeflow `Profile` and the user must be bound to the namespace. Follow the namespace binding steps in [Install Kubeflow Plugins](../../training_pipelines/kubeflow/install.mdx).
