...
The manifests are in `docs/en/ai_applications/kagenti/assets/envoy_ai_gateway_mcp`. They
...
```bash
EXAMPLE_DIR=docs/en/ai_applications/kagenti/assets/envoy_ai_gateway_mcp
...
kubectl apply -f docs/en/ai_applications/kagenti/assets/envoy_ai_gateway_mcp/04-agent.yaml
