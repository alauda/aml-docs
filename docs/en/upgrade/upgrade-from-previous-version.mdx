...
2. [Downloading](../model_inference/kserve/install.mdx#upload-operator) operator bundle packages for `Alauda Build of KServe`.
...
For detailed installation and configuration steps, please refer to the [Alauda Build of KServe Installation Guide](../model_inference/kserve/install.mdx).
