...
Download `Qwen/Qwen3-0.6B` (or any HF model) and push it to the platform model repository. See [Upload Models Using Notebook](../../develop/workbench/upload_models_using_notebook.mdx).
