...
|---|---|---|
| SFT comprehensive tutorial | SFT | [`sft-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/guides/sft-comprehensive-tutorial.ipynb) |
| OSFT comprehensive tutorial | OSFT | [`osft-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/guides/osft-comprehensive-tutorial.ipynb) |
| QLoRA comprehensive tutorial | QLoRA | [`qlora-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/guides/qlora-comprehensive-tutorial.ipynb) |
| CPT comprehensive tutorial | CPT | [`cpt-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/guides/cpt-comprehensive-tutorial.ipynb) |
