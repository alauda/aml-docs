...
- [`cluster-queues.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/guides/assets/kueue/preemption/cluster-queues.yaml) — the cohort, both ClusterQueues, and the `ResourceFlavor`. Edit `nominalQuota` and `borrowingLimit` to match the GPUs you want to lend out.
- [`workload-priorities.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/guides/assets/kueue/preemption/workload-priorities.yaml) — two `WorkloadPriorityClass` values: `c12-inference-prio=1000`, `c12-training-prio=10`. Without these, the cohort reclamation rule still fires, but you have no in-queue priority order.
- [`local-queues.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/guides/assets/kueue/preemption/local-queues.yaml) — `c12-inference-lq` and `c12-training-lq`, one per ClusterQueue.
...
The [`training-runtime.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/guides/assets/kueue/preemption/training-runtime.yaml) asset bundles all four into a runnable `TrainingRuntime`. The trainer-script core looks like this:
