...
|---|---|---|
| SFT comprehensive tutorial | SFT | [`sft-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/how_to/sft-comprehensive-tutorial.ipynb) |
| OSFT comprehensive tutorial | OSFT | [`osft-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/how_to/osft-comprehensive-tutorial.ipynb) |
| QLoRA comprehensive tutorial | QLoRA | [`qlora-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/how_to/qlora-comprehensive-tutorial.ipynb) |
| CPT comprehensive tutorial | CPT | [`cpt-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/train/how_to/cpt-comprehensive-tutorial.ipynb) |
