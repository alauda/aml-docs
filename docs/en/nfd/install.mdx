...
<ExternalSiteLink
  name="acp"
  href="ui/cli_tools/index.html#uploading-cluster-plugins"
...
After the upgrade, verify that the required node identity labels remain present
and that separately managed driver and Device Plugin images have not changed.
