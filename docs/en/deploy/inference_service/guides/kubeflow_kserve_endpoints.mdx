...
Use this page when your team already works in the Kubeflow dashboard. For the platform's own deployment experience — Model Catalog and Model Registry integration, inference service templates, and batch operations — see [Managing Inference Services](../inference_service.mdx).
