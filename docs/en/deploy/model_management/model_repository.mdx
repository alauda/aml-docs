...
Refer to [Upload Models Using Notebook](../../develop/workbench/upload_models_using_notebook.mdx) for detailed steps on uploading model files to the model repository.
