...
Refer to [Upload Models Using Notebook](../../../develop/how_to/upload_models_using_notebook.mdx) for detailed steps on uploading model files to the model repository.
