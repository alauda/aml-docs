...
If you want to manage reusable project-level S3, URI, or OCI endpoints in the UI, see [Using Connections](../../../develop/connections/how_to/using_connections.mdx).
...
- The workbench is attached to the persistent volume (PVC).
  ...
  For instructions on creating a workbench and attaching a PVC, see [Create Workbench](../../../develop/workbench/how_to/create_workbench.mdx).
