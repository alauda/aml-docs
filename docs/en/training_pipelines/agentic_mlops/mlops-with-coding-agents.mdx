...
- Configuring the inference traffic gateway — authentication and rate limits via [Alauda Build of Envoy AI Gateway](../../model_inference/envoy_ai_gateway/intro.mdx).
...
Alauda Build of Envoy AI Gateway is a required dependency of Alauda Build of KServe and fronts inference traffic with an OpenAI-compatible API surface, AI-aware routing, and per-model policies (see [Envoy AI Gateway introduction](../../model_inference/envoy_ai_gateway/intro.mdx) and [installation](../../model_inference/envoy_ai_gateway/install.mdx)). The agent is well-suited to author its CRDs, which are otherwise verbose:
...
| Already-tuned model needs to fit a smaller GPU before serving | LLM Compressor | [LLM Compressor with Alauda AI](../../model_inference/llm_compressor/how_to/compressor_by_workbench.mdx) |
...
For experiment tracking and run metadata, [MLflow on Kubeflow](../../data_experiments/mlflow/intro.mdx) is the platform-native option; tell the agent to log there from inside the training code so the report has a real source of truth.
...
- [Envoy AI Gateway — introduction](../../model_inference/envoy_ai_gateway/intro.mdx)
- [Install Envoy AI Gateway](../../model_inference/envoy_ai_gateway/install.mdx)
...
- [LLM Compressor with Alauda AI](../../model_inference/llm_compressor/how_to/compressor_by_workbench.mdx)
- [MLflow on Kubeflow](../../data_experiments/mlflow/intro.mdx)
