...
| Track a KFP run's parameters and metrics in MLflow | KFP component + MLflow SDK | [Kubeflow Pipeline + MLflow Integration](../../data_experiments/mlflow/how_to/pipelines-mlflow-integration.mdx) |
