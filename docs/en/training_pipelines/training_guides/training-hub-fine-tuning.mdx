...
|---|---|---|
| SFT comprehensive tutorial | SFT | [`sft-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/training_pipelines/training_guides/sft-comprehensive-tutorial.ipynb) |
| OSFT comprehensive tutorial | OSFT | [`osft-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/training_pipelines/training_guides/osft-comprehensive-tutorial.ipynb) |
| QLoRA comprehensive tutorial | QLoRA | [`qlora-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/training_pipelines/training_guides/qlora-comprehensive-tutorial.ipynb) |
| CPT comprehensive tutorial | CPT | [`cpt-comprehensive-tutorial.ipynb`](https://github.com/alauda/aml-docs/tree/master/docs/en/training_pipelines/training_guides/cpt-comprehensive-tutorial.ipynb) |
...
**NPU:** bitsandbytes 4-bit is not available on Huawei Ascend. Use LoRA (without 4-bit) on
the `llamafactory0.9-cann8.5-arm64` runtime (`finetuning_type: lora`) as the
parameter-efficient path — see [Fine-tune and Pretrain on Ascend NPU](./fine-tune-and-pretrain-llms-on-ascend-npu.mdx).
:::
...
:::note
**NPU:** Full-parameter continued pre-training also runs on Huawei Ascend via the
`MindSpeed-LLM` runtime (`pretrain_gpt.py`). See
[Fine-tune and Pretrain on Ascend NPU](./fine-tune-and-pretrain-llms-on-ascend-npu.mdx) and
the `qwen25_pretrain_verify.ipynb` recipe.
:::
