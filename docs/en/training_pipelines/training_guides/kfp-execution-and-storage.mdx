...
Download
[`verify-kfp-features.py`](https://github.com/alauda/aml-docs/tree/master/docs/en/training_pipelines/training_guides/assets/pipelines/verify-kfp-features.py)
