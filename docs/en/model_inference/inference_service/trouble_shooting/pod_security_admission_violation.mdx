...
To resolve this issue, you must adjust the **Pod Security Admission** configuration for the `namespace` where your inference service is deployed. Follow these steps:
