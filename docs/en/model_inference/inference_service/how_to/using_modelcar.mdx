...
spec:
  predictor:
    ...
    model:
      ...
      storageUri: oci://alaudadockerhub/models-qwen2.5:v1 # [!code callout]
    securityContext:
      seccompProfile:
        type: RuntimeDefault
```
...
4. `storageUri` specifies the OCI image URI with tag where the model is stored. Use a fully qualified registry URL. For example: `storageUri: oci://alaudadockerhub/models-qwen2.5:v1`
</Callouts>
