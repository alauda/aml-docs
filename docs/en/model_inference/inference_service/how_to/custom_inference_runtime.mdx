  ...
  containers:
    - command:
        ...
        - >
          ...
          # 3. initialize Ascend toolkit environment
...
5. `runAsUser: 1000` aligns the runtime container with the platform default Modelcar UID and the common Ascend device permission model.
</Callouts>
