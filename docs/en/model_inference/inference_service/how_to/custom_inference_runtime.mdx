...
* **CPU Runtime Example**
        ...
        spec:
          ...
          - name: kserve-container
            image: build-harbor.alauda.cn/mlops/xinference:1.2.2-cpu-v1.3.0 # Replace with your actual CPU runtime image
            env:
            - name: MODEL_PATH # The path to the model directory is a required parameter across all runtimes.
              value: /mnt/models/{{ index .Annotations "aml-model-repo" }}
            - name: MODEL_UID # The MODEL_UID parameter is optional for other runtimes.
              value: '{{ index .Annotations "aml-model-repo" }}'
            - name: MODEL_ENGINE # The MODEL_UID parameter is optional for other runtimes.
              value: "transformers"
            - name: MODEL_FAMILY # Required parameter for xinference runtime, please set it based on your model family, value: "llama" # e.g., "llama", "chatglm", etc.
              value: ""
            command:
            - bash
            - -c
