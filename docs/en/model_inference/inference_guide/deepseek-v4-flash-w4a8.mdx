...
| Spec | File |
|---|---|
| agg-base, TP=8 | [`deepseek-v4-flash-w4a8-agg-base-llmisvc.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/model_inference/inference_guide/assets/deepseek-v4-flash-w4a8/deepseek-v4-flash-w4a8-agg-base-llmisvc.yaml) |

```bash
base=https://raw.githubusercontent.com/alauda/aml-docs/master/docs/en/model_inference/inference_guide/assets/deepseek-v4-flash-w4a8
