...
| ModelCar (OCI Image Layout tar) | `http://package-minio.alauda.cn:9199/packages/aml-models-oci/v0.1.0/DeepSeek-V4-Flash-w8a8-mtp/DeepSeek-V4-Flash-w8a8-mtp.oci.tar` |
...
| Spec | File |
|---|---|
| agg-mc-kv, DP2 × TP=8 | [`deepseek-v4-flash-w8a8-agg-mc-kv-llmisvc.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/model_inference/inference_guide/assets/deepseek-v4-flash-w8a8/deepseek-v4-flash-w8a8-agg-mc-kv-llmisvc.yaml) |

```bash
base=https://raw.githubusercontent.com/alauda/aml-docs/master/docs/en/model_inference/inference_guide/assets/deepseek-v4-flash-w8a8
...
curl -sO http://package-minio.alauda.cn:9199/packages/aml-models-oci/v0.1.0/DeepSeek-V4-Flash-w8a8-mtp/DeepSeek-V4-Flash-w8a8-mtp.oci.tar
skopeo copy --all \
