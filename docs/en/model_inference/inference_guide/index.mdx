...
scheduling) see [Model Deployment & Inference](../index.mdx).
...
[`assets/`](https://github.com/alauda/aml-docs/tree/master/docs/en/model_inference/inference_guide/assets)
...
```bash
base=https://raw.githubusercontent.com/alauda/aml-docs/master/docs/en/model_inference/inference_guide/assets
...
image against the published public key ([`cosign.pub`](https://raw.githubusercontent.com/alauda/aml-docs/master/docs/en/model_inference/inference_guide/cosign.pub))
before deploying:

```bash
curl -sO https://raw.githubusercontent.com/alauda/aml-docs/master/docs/en/model_inference/inference_guide/cosign.pub
