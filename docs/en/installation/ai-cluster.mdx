...
Install the following dependent components on the target cluster before installing Alauda AI. They provide the authentication, metadata storage, and cache services required by [Model as a Service (MaaS)](../maas/intro.mdx):
