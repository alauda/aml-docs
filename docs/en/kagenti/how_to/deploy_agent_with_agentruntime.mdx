...
1. [Install the Secure-Profile Dependencies](./install_secure_dependencies.mdx) — SPIRE, Keycloak, Istio ambient.
2. [Enable the Secure Profile](./enable_secure_profile.mdx) — flip the operand feature gates.
