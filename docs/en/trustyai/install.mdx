...
After the operator is installed, users can use CRDs such as **LMEvalJob**, **GuardrailsOrchestrator**, and **NemoGuardrails** to manage model evaluation tasks and AI guardrails orchestration (both FMS Guardrails and NeMo Guardrails).

See the [Evaluate LLM](./lm-eval), [AI Guardrails for LLM safety](./ai-guardrails), and [NeMo Guardrails](./nemo-guardrails) sections for details.
