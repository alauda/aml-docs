...
| Spec | File |
|---|---|
| agg-base (load-balancing) | [`qwen3-32b-agg-base-llmisvc.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/plan/validated_models/assets/qwen3-32b/qwen3-32b-agg-base-llmisvc.yaml) |
| agg-mc-kv (KV store + KV-cache-aware routing) | [`qwen3-32b-agg-mc-kv-llmisvc.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/plan/validated_models/assets/qwen3-32b/qwen3-32b-agg-mc-kv-llmisvc.yaml) |
