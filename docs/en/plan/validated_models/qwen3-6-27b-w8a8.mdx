...
| Spec | File |
|---|---|
| agg-base (load-balancing) | [`qwen3-6-27b-w8a8-agg-base-llmisvc.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/plan/validated_models/assets/qwen3-6-27b-w8a8/qwen3-6-27b-w8a8-agg-base-llmisvc.yaml) |
