...
| Spec | File |
|---|---|
| agg-base, TP=8 | [`deepseek-v4-flash-w4a8-agg-base-llmisvc.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/plan/validated_models/assets/deepseek-v4-flash-w4a8/deepseek-v4-flash-w4a8-agg-base-llmisvc.yaml) |
