...
| ModelCar (OCI Image Layout tar) | `http://<model-package-host>/packages/aml-models-oci/v0.1.0/MiniMax-M2.5-w8a8-QuaRot/MiniMax-M2.5-w8a8-QuaRot.oci.tar` |
...
store, not a public Docker Hub image. Replace `<model-package-host>` in the link above
with the package store address supplied by Alauda for the environment. The benchmark itself was run with the
...
| Spec | File |
|---|---|
| agg, DP2 × TP=8 | [`minimax-m2.5-w8a8-agg-llmisvc.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/plan/validated_models/assets/minimax-m2.5-w8a8/minimax-m2.5-w8a8-agg-llmisvc.yaml) |

```bash
base=https://raw.githubusercontent.com/alauda/aml-docs/master/docs/en/plan/validated_models/assets/minimax-m2.5-w8a8
...
#      curl -sO http://<model-package-host>/packages/aml-models-oci/v0.1.0/MiniMax-M2.5-w8a8-QuaRot/MiniMax-M2.5-w8a8-QuaRot.oci.tar
#      skopeo copy --all \
