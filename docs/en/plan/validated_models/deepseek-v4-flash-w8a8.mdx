...
| Spec | File |
|---|---|
| agg-mc-kv, DP2 × TP=8 | [`deepseek-v4-flash-w8a8-agg-mc-kv-llmisvc.yaml`](https://github.com/alauda/aml-docs/tree/master/docs/en/plan/validated_models/assets/deepseek-v4-flash-w8a8/deepseek-v4-flash-w8a8-agg-mc-kv-llmisvc.yaml) |
