...
Gemma-4-31B-it uses the same 8k / 128 scenario and concurrency sweep, but is sent
directly to its P4+D4 proxy because the MaaS backend was still attached to the older
aggregate service at measurement time.
