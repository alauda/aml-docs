...
Below diagram illustrates the architecture of Alauda AI platform.
...
| skipper & oauth2-proxy | Proxy traffics from global cluster to workload clusters. Traffics are authencated by oauth2-proxy | Open source | Apache Version 2.0 |
...
| aml-api-deploy | Providess high-level APIs for "Lich" | Self-developed |     |
...
| Fine Tunning | Experimental UI providing no-code LLM fine tunning job creation and management | Self-developed |     |
...
| Dify | Open source plugin for creating LLM Agents, RAG applications using web UI | Open source | ```<br>a modified version of the Apache License 2.0<br>``` |
