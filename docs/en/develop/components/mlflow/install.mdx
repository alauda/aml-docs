...
- If requests are denied (`403 PERMISSION_DENIED`), check the user's Kubernetes `RoleBinding` in the workspace namespace — see [Workspaces and access control](../../../administer/how_to/mlflow_workspaces.mdx).
