...
- If requests are denied (`403 PERMISSION_DENIED`), check the user's Kubernetes `RoleBinding` in the workspace namespace — see [MLflow Workspaces and Access Control](../../../administer/multi_tenant/mlflow_workspaces.mdx).
