...
Workspace membership and permissions are therefore managed with ordinary Kubernetes `Role` / `RoleBinding` objects — see [Workspaces and access control](../../../administer/how_to/mlflow_workspaces.mdx).
