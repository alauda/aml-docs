...
:::info
A `Succeeded` CSV means the operator controller is running. The KFP pipeline stack itself only appears once you create a `DataSciencePipelinesApplication` — see [Create a Data Science Pipelines Application](../../pipelines/create_dspa.mdx).
:::
