...
For direct YAML examples of model deployment from S3, PVC, or OCI sources, see [Model Storage](../../../deploy/model_management/functions/model_storage.mdx).
...
1. In **User View**, open the target project.
2. Click **Connections**.
