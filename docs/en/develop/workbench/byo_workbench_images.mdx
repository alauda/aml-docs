...
# docker image inspect ${BASE_IMAGE} --format '{{.Config.User}}'
ARG BASE_USER=1001
USER ${BASE_USER}
...
docker buildx build --platform linux/amd64 \
  ...
  -t registry.example.com/mlops/workbench-images/byo-jupyter-cuda:2026.09.0 \
  --push .
...
docker buildx build --platform linux/arm64 \
  ...
  -t registry.example.com/mlops/workbench-images/byo-jupyter-cann:2026.09.0 \
  --push .
```
