...
- KFP object storage is configured. For the namespace-side `kfp-launcher` configuration, see [Use Kubeflow Pipelines](../../how_to/pipelines.mdx).
...
- KFP is configured to store artifacts in object storage. See [Use Kubeflow Pipelines](../../how_to/pipelines.mdx).
