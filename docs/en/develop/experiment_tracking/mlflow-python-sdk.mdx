...
You can only use a workspace your account has access to; see [Workspaces and access control](../../administer/how_to/mlflow_workspaces.mdx).
...
| `403 PERMISSION_DENIED` | Your account lacks access to the workspace namespace. Request access to the workspace (see [Workspaces and access control](../../administer/how_to/mlflow_workspaces.mdx)); no ServiceAccount is involved. |
