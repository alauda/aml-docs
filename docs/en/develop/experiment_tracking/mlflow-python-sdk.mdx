...
You can only use a workspace your account has access to; see [MLflow Workspaces and Access Control](../../administer/multi_tenant/mlflow_workspaces.mdx).
...
| `403 PERMISSION_DENIED` | Your account lacks access to the workspace namespace. Request access to the workspace (see [MLflow Workspaces and Access Control](../../administer/multi_tenant/mlflow_workspaces.mdx)); no ServiceAccount is involved. |
