...
- A workbench image and the [data-free compressor notebook](/data-free-compressor.ipynb) that demonstrate how to compress a model, with an optional example for evaluating the compressed model.
- A workbench image and the [calibration compressor notebook](/calibration-compressor.ipynb) that demonstrate how to compress a model using a calibration dataset, with an optional example for evaluating the model after compression.
